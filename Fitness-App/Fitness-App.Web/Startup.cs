...
namespace Fitness_App.Web
{
    public class Startup
    {
        ...
        {
            services.AddDbContextPool<Fitness_AppDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
            ...
            services.AddTransient<Fitness_AppDbContext>();
        }
